...
do
    ...
    echo "$line4" >> test.temp
    echo "$line5" >> test.temp
    echo "$line6" >> test.temp
    ...
    echo "$line5" >> test.results
    echo "$line6" >> test.results

    printf "EXPECTED OUTPUT================\n" >> test.results
    echo "$line7" >> test.results

    printf "OUTPUT================\n" >> test.results
    cat test.temp | ./2d-array >> test.results
done < "$input"
